...
# 1 "MCAL_LAYER/GPIO_hal.h" 1
# 13 "MCAL_LAYER/GPIO_hal.h"
...
# 13 "MCAL_LAYER/GPIO_hal.h" 2

# 1 "MCAL_LAYER/MCAL_STD_Types.h" 1
# 12 "MCAL_LAYER/MCAL_STD_Types.h"
# 1 "MCAL_LAYER/STD_Library.h" 1
# 13 "MCAL_LAYER/STD_Library.h"
...
# 15 "MCAL_LAYER/GPIO_hal.h" 2
# 25 "MCAL_LAYER/GPIO_hal.h"
...
unsigned char GPIO_PIN_Write_logic(GPIO_PIN_CONFIG *_pin,GPIO_PIN_LOGIC _logic){
    ...
    if(((void*)0) == _pin){
        ...
        if(GPIO_PIN_LOGIC_LOW == _logic ){
            (*LAT_REG[_pin->pin_port] &=(~(1<<_pin->pin_num)));
        }
...
unsigned char GPIO_PIN_Read_Logic(GPIO_PIN_CONFIG *_pin,GPIO_PIN_LOGIC *_logic){
    unsigned char Ret = 0x01 ;
    if(((void*)0) == _pin || ((void*)0) == _logic){
        Ret = 0x00 ;
    }
    else{
        *_logic = ((*PORT_REG[_pin->pin_port]>>_pin->pin_num)& 1);
    }
    return Ret ;
}
...
unsigned char GPIO_PIN_Give_Direction(GPIO_PIN_CONFIG *_pin,GPIO_PIN_DIRECTION _direction){
    ...
    if(((void*)0) == _pin){
        ...
        if(GPIO_PIN_INPUT == _direction){
            (*TRIS_REG[_pin->pin_port] |=(1<<_pin->pin_num));
        }
...
unsigned char GPIO_PIN_Get_Direction(GPIO_PIN_CONFIG *_pin,GPIO_PIN_DIRECTION *_direction){
    unsigned char Ret = 0x01 ;
    if(((void*)0) == _pin || ((void*)0) == _direction){
        Ret = 0x00 ;
    }
    else{
        *_direction = ((*TRIS_REG[_pin->pin_port]>>_pin->pin_num)& 1);
    }
    return Ret ;
}
...
unsigned char GPIO_PORT_Get_Direction(GPIO_PORT_CONFIG *_port,unsigned char *_direction){
    unsigned char Ret = 0x01 ;
    if(((void*)0) == _port || ((void*)0) == _direction){
        Ret = 0x00 ;
    }
    else{
