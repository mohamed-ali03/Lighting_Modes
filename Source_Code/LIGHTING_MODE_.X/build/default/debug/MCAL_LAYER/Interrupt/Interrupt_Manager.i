...
# 1 "MCAL_LAYER/Interrupt/Interrupt_Mananger.h" 1
# 12 "MCAL_LAYER/Interrupt/Interrupt_Mananger.h"
...
# 12 "MCAL_LAYER/Interrupt/Interrupt_Mananger.h" 2
...
void __attribute__((picinterrupt(("")))) InterruptMangerHigh(){
   if(1 == INTCONbits.INT0F && 1 == INTCONbits.INT0E){
        INT0_ISR();
    }else{ }
}
void __attribute__((picinterrupt(("low_priority")))) InterruptMangerLow(){
